...
class Operate:
    ...
    def draw(self, canvas):
        ...
        notifiation = pygame.font.Font('pics/8-BitMadness.ttf', 40).render(self.notification,
                                       False, text_colour)
        ...
        if time_remain > 0:
            ...
            time_remain = ""
        count_down_surface = pygame.font.Font('pics/8-BitMadness.ttf', 40).render(time_remain, False, (50, 50, 50))
    ...
    def put_caption(canvas, caption, position, text_colour=(200, 200, 200)):
        caption_surface = pygame.font.Font('pics/8-BitMadness.ttf', 35).render(caption,
                                            False, text_colour)
    ...
    def robot_position(self):
        return self.ekf.get_state_vector(self)[:3]
