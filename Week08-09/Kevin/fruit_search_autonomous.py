...
if __name__ == "__main__":
    ...
    parser.add_argument('--slam', type=str, default='lab_output.txt') # change
    parser.add_argument('--target', type=str, default='lab_output.txt') # change    parser.add_argument("--ip", metavar='', type=str, default='192.168.50.1')
    ...
    n_iter = 1000
    radius = 0.1 #float(input("Enter radius: ")) #last used was 0.11
    stepSize = 0.2 # float(input("Enter step size: ")) #last used was 0.1
    ...
    for target in coords_order: #loop for every shopping list target
        ...
        # in rrt have a function that when branch expands, check if the wwaypoint is inside a radius of obstacle, 

        # drive into final waypoint, 
