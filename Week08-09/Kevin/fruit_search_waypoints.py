...
if __name__ == "__main__":
    ...
    parser.add_argument("--map", type=str, default='Full_Map.txt') # Map created using slam and targets
    parser.add_argument('--slam', type=str, default='lab_output/slam.txt') # slam map
    parser.add_argument('--target', type=str, default='lab_output/targets.txt') # target map
